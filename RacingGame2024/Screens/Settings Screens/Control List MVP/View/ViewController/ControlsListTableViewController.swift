...
private extension String {
    static let title = "Выберите управление"
    static let identifier = "controlsListCell"
}

final class ControlsListTableViewController: UITableViewController {

    weak var delegate: OptionsDelegate?
    
    var presenter: IControlsListPresenter
    
    init(presenter: IControlsListPresenter) {
